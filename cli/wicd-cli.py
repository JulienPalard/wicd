...
def is_valid_wireless_network_id(wireless, network_id):
...
def is_valid_wired_network_id(wired, network_id):
...
def is_valid_wired_network_profile(wired, profile_name):
